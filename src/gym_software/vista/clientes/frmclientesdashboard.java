 ...
 * @author pc
 */
public class frmclientesdashboard extends javax.swing.JFrame {
    private Integer isSuperAdmin = 0;

    /**
     * Creates new form frmadministradores
     */
    public frmclientesdashboard(Integer isAdmin) {
        initComponents();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (selectedRow != -1) {
            ...
            Object id = tbadmins.getValueAt(selectedRow, 4); // Suponiendo que el ID está en la primera columna
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // TODO add your handling code here:
        frmclientesdashboard frmadmin = new frmclientesdashboard(this.isSuperAdmin);
    ...
    private void btnNewAdminActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNewAdminActionPerformed
        // TODO add your handling code here:
        frmnewcliente newAdmin = new frmnewcliente(this.isSuperAdmin);
    ...
    private void ejecutarLLamadoPrincipal() {
                ...
                try {
                    Conexion conexion = new Conexion();
                    String getAllAdmins = """
                                        select id, nombre, apellido, telefono, genero, direccion, estado, (
                                        	select nombre
                                        	from admins 
                                        	where id = c.id_admin_referido
                                        ) as admin_referido
                                        from clientes c ;
                                        """;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmclientesdashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void actualizarRegistro(Object id, String columnName, Object newValue) {
        System.out.println(id);
        String query = "UPDATE clientes SET " + columnName + " = ? WHERE id = ?";
